...
import { Alert, Badge, Button, Group, NumberInput, Paper, SimpleGrid, Stack, Switch, Text, ThemeIcon } from '@mantine/core';
...
import { deriveAutoEventSettingsFromStatistics, selectGroupTransitionStatistics } from '../../store/statisticsSelectors';
...
function OrgaTabEvents() {
  ...
  const derivedStatisticsSettings = React.useMemo(
    () => deriveAutoEventSettingsFromStatistics(transitionStatistics, groupDefs, autoEventSettings),
    [autoEventSettings, groupDefs, transitionStatistics]
  );
  ...
  function bindToStatistics() {
    ...
    updateAutoEventSettings({
      kita: { ...derivedStatisticsSettings.kita },
      school: { ...derivedStatisticsSettings.school },
      statisticsBinding: {
        appliedAt,
        snapshot: {
          kita: { ...derivedStatisticsSettings.kita },
        ...
        <Stack gap="sm">
          ...
          <Group justify="space-between" align="center" wrap="wrap">
            <Button onClick={bindToStatistics} data-testid="auto-events-bind-statistics">
              Werte aus Statistik übernehmen
            </Button>
          ...
          <Paper key={group.date} withBorder p="md" radius="md">
            <Stack gap="sm">
              ...
              {group.events.map((event) => {
                ...
                return (
                  <Group key={event.id} justify="space-between" align="center" wrap="wrap">
                    <div style={{ flex: 1 }}>
                      <Group gap="xs" mb={4}>
