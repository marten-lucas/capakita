...
function buildAutomaticTransitionEvents({ dataItems, existingEvents = [], scenarioId, disabledIds = {} }) {
    const events = [];
        ...
        const transitions = [
            {
                ...
                effectiveDate: addYearsToIsoDate(item.dateofbirth, 3),
                description: 'Automatischer Gruppenwechsel: Krippe → Kita',
                targetStage: 'kita'
            },
            {
                id: `auto_transition_school_${itemKey}`,
                effectiveDate: addYearsToIsoDate(item.dateofbirth, 6),
...
function extractEventsForScenario(state, scenarioId, disabledIds = {}) {
    ...
    events.push(...buildAutomaticTransitionEvents({ dataItems, existingEvents: events, scenarioId, disabledIds }));
